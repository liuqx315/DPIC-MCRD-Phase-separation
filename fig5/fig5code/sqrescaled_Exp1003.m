...
%%group:20+0.6
folder = "../20230704&05 Droplet fusion/10+0.3 400R/10+0.3 400R FAM";
...
h = legend('$1290$ s', '$2790$ s', '$4290$ s', '$5790$ s', '$7290$ s') ;
...
text(7,150,'Slope $\sim -4.0$','fontsize',FS,'rotation',-56,'Interpreter','LaTex') ;
