...
dat1=load('../rho3_25_005/sklaw_data1.mat');
datDDA=dat1.B;
Time=dat1.Time;
%StartT=50;
...
save('Sim325v3.mat','T','Sq_rt','Kmax','SqQmax2','Q_Qmax') ;
%%
%%
data=load("Sim325v3.mat")
...
text(4,90,'Slope $\sim -4.6$','fontsize',FS,'rotation',-63,'Interpreter','LaTex') ;
text(0.16,14,'Simulations:','fontsize',FS,'Interpreter','LaTex') ;
...
save2pdf('rescaledSq_sim0325v3.pdf',gcf,600) ;
% x=Q_Qmax(:,2);
% x=log10(x);
% y=SqQmax2(:,2);
% y=log10(y);
