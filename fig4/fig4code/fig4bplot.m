...
clear all
% 定义文件夹路径
folderPath = '../fig4data/Exp_10+03/';
%data2
folderPath2 = '../fig4data/Exp_20+0.6/';
...
for i = 1:Tmax
    ...
    data = load(strcat(folderPath,filenames{i}));
...
for i = 1:Tmax2
    ...
    data2 = load(strcat(folderPath2,filenames2{i}));
...
errorbar(avg_wavenumber(:,1:30)./184,avg_growth_rate(:,1:30),se_growth_rate(:,1:30),'o','MarkerFaceColor', [0.68, 0.92, 1.00], 'MarkerEdgeColor', 'black','LineWidth',1.5)
errorbar(avg_wavenumber./184,avg_growth_rate2,se_growth_rate2,'D', 'MarkerFaceColor', [1.0, 0.41, 0.16], 'MarkerEdgeColor', 'black','LineWidth',1.5)
...
% 
data1 = [avg_wavenumber.'/184, avg_growth_rate.', se_growth_rate.', avg_growth_rate2.', se_growth_rate2.'];
data2 = [k2.'/184, lambda1.', lambda12.'];
% 
writematrix(data1, 'fig4_experiment0619.xls');
writematrix(data2, 'fig4_Theory0619.xls');
